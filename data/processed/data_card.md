...
- **Подсолнечник/рапс/лён 2024–2025 — структурный сдвиг** (гибриды, площади:
  ...
  но gate «strong» требует MAE win И R²>0 (см. src/evaluate.py): рапс
  (R² −0.79, bias +3.3, покрытие 0.04) и лён (хуже бейзлайна) —
  `below_baseline:true`, честный experimental fallback. Фиксируем честно.
